...
export default function PublicThreadPage() {
  ...
  return (
    <main className="container mx-auto px-4 py-8 min-h-[calc(100vh-80px)]">
      {loading ? (
        <div className="rounded-lg border border-gray-700 bg-gray-800 p-4 text-sm text-gray-400">Caricamento…</div>
      ) : !thread ? (
        <div className="rounded-lg border border-gray-700 bg-gray-800 p-4 text-sm text-gray-400">Discussione non trovata</div>
      ) : (
        <>
          <div className="rounded-lg border border-gray-700 bg-gray-800 p-4 mb-4">
            ...
            <h1 className="text-2xl font-bold text-white mt-1">{thread.title}</h1>
          ...
          <div className="rounded-lg border border-gray-700 bg-gray-800 divide-y divide-gray-700 mb-4">
